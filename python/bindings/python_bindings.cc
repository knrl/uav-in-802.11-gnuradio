...
void bind_sync_short(py::module& m);
    ...
    void bind_ofdm_demapper(py::module& m);
    void bind_alamouti_decode_cc(py::module& m);
...
PYBIND11_MODULE(ieee802_11_python, m)
{
    ...
    bind_my_strobe(m);
    bind_ofdm_mapper(m);
    bind_ofdm_demapper(m);
    bind_alamouti_decode_cc(m);
    bind_alamouti_encode_cc(m);
    bind_alamouti_ofdm_rx(m);
    bind_alamouti_ofdm_tx_cc(m);
    bind_ofdm_insert_preamble_tagged(m);
