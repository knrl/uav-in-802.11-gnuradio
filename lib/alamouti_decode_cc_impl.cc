...
alamouti_decode_cc::sptr alamouti_decode_cc::make()
{
    return gnuradio::make_block_sptr<alamouti_decode_cc_impl>();
}
...
void alamouti_decode_cc_impl::forecast(int noutput_items,
...
void alamouti_decode_cc_impl::recieve_pilot (int &consumed_inputs,const int noutput_items,
...
int alamouti_decode_cc_impl::general_work(int noutput_items,
